    ...
    <div className="d-flex align-items-center flex-column bg-light mt-5 py-3">
      <Link onClick={props.toggleScroll} className="font-weight-light text-decoration-none lead azul">
        ...
        <div className="d-md-flex text-center my-2">
          <NavLink to='/error404' className="text-dark px-2">Políticas de privacidad</NavLink>
          <NavLink to='' className="text-dark px-2">Contacto</NavLink>
          <NavLink to='/error404' className="text-dark px-2">Contrato de suscripción</NavLink>
        </div>
